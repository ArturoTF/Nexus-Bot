import discord
import os
from src.app.modules.traductor.traductor import bot  # Asume que este es el bot ya inicializado
from discord import SlashCommand  # Esto ahora viene de una extensión compatible
from src.app.modules.bot_commands.basicCommands import register_commands  # Asume que has renombrado tu módulo a bot_commands y tiene una función register_commands
